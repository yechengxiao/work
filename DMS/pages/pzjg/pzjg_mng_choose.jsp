...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=baseWebPath%>/css/zTreeStyle.css"/>
        ...
        function f_delete() {
            ...
            if (inspectBox(document.all.rowflag) != "") {
                if (confirm("确定删除所选的记录吗？")) {
                    ...
                    form2.action = "<%=baseWebPath%>/pzjg/deletePzjgAction.action";
                    disableAllSubmit();
                    form2.submit();
                }
                else
    ...
    <table style="width: 100%;" cellspacing="0">
        <tr style="height:25px">
            ...
            <td align="right">
                ...
                <input type="button" id="fimport" class="button" value="导入" onclick="f_import()"/>
...
<div id="serach_container"
     style="width: 800px; margin-left:3px; margin-top:5px;">
    <fieldset style="width: 795px" id="FIELDSET1">
        ...
        <table style="width: 795px">
            ...
            <tr>
                ...
                <td><s:textfield cssStyle="width:100px" cssClass="upper"
                                 id="vsn" name="pzjgParam.vsn"
                                 value="%{#session.pzjgConParas.pzjgParam.vsn}" maxlength="10"/>
                </td>
                <td align="right">车系分类&nbsp;</td>
                <td><s:textfield cssStyle="width:100px" cssClass="upper"
                                 id="cxfl" name="pzjgParam.cxfl"
                                 value="%{#session.pzjgConParas.pzjgParam.cxfl}" size="20"/></td>
                <td align="right">配置类型&nbsp;</td>
                <td><s:textfield id="pzlx" cssStyle="width:100px"
                                 cssClass="upper" name="pzjgParam.pzlx"
                                 value="%{#session.pzjgConParas.pzjgParam.pzlx}" size="20"/></td>
                <td align="right">状态&nbsp;</td>
                <td><s:select name="pzjgParam.zt"
                              list="#{'':'请选择状态','0':'停产','1':'正常' }" id="zt" theme="simple"/>
                </td>

            </tr>
            <tr>
                <td align="right">车系&nbsp;</td>
                <td><s:select name="pzjgParam.cx" list="cx" emptyOption="true"
                              cssStyle="width:100px" value="%{#session.pzjgConParas.pzjgParam.cx}"/>
                </td>
                <td align="right">车型描述&nbsp;</td>
                <td><s:select name="pzjgParam.xhms" list="xhms" emptyOption="true"
                              cssStyle="width:100px"
                              value="%{#session.pzjgConParas.pzjgParam.xhms}"/></td>
                <td align="right">车辆颜色&nbsp;</td>
                <td><s:select name="pzjgParam.clys" list="clys" emptyOption="true"
                              cssStyle="width:100px"
                              value="%{#session.pzjgConParas.pzjgParam.clys}"/>
                </td>
            </tr>
        </table>
    </fieldset>
...
<tr id="tb_field" class="field">
    <th><input type="checkbox" name="all_flag"
               onclick="ck_select(this,'rowflag');"/>
    </th>
    <th><a onclick="f_sort('vsn');return false;"
           href="javascript:void(0);"> <span>销售物料编号</span> <span
            id="gsbz" class="ordertip"></span> </a>
    </th>
    <th><a onclick="f_sort('pp');return false;"
           href="javascript:void(0);"> <span>品牌</span><span class="arr"></span>
    </a>
    </th>
    <th><a onclick="f_sort('cx');return false;"
           href="javascript:void(0);"> <span>车系</span><span class="arr"></span>
    </a>
    <th><a onclick="f_sort('cxfl');return false;"
           href="javascript:void(0);"> <span>车系分类</span> <span id="gsdm"
                                                               class="ordertip"></span> </a>
    </th>
    </th>
    <th><a onclick="f_sort('xhms');return false;"
           href="javascript:void(0);"> <span>车型描述</span> <span id="gwmc"
                                                               class="ordertip"></span> </a>
    </th>
    <th><a onclick="f_sort('clys');return false;"
           href="javascript:void(0);"> <span>车辆颜色</span><span class="arr"></span>
    </a>
    </th>
    <th><a onclick="f_sort('yswd');return false;"
           href="javascript:void(0);"> <span>颜色未定</span><span class="arr"></span>
    </a>
    </th>
    <th><a onclick="f_sort('xh');return false;"
           href="javascript:void(0);"> <span>车型代码</span><span class="arr"></span>
    </a>
    </th>
    <th><a onclick="f_sort('cpms');return false;"
           href="javascript:void(0);"> <span>产品描述</span><span class="arr"></span>
    </a>
    </th>
    <th><a onclick="f_sort('zt');return false;"
           href="javascript:void(0);"> <span>状态</span><span class="arr"></span>
    </a>
    </th>
    <th><a onclick="f_sort('pzlx');return false;"
           href="javascript:void(0);"> <span>配置类型</span><span class="arr"></span>
    </a>
    </th>
    <th><a onclick="f_sort('fdjxh');return false;"
           href="javascript:void(0);"> <span>发动机型号</span><span
            class="arr"></span> </a>
    </th>
    <th><a onclick="f_sort('abs');return false;"
           href="javascript:void(0);"> <span>ABS</span><span class="arr"></span>
    </a>
    </th>
    <th><a onclick="f_sort('ns');return false;"
           href="javascript:void(0);"> <span>内饰</span><span class="arr"></span>
    </a>
    </th>
    <th><a onclick="f_sort('xzj');return false;"
           href="javascript:void(0);"> <span>选装件</span><span class="arr"></span>
    </a>
    </th>
    <th><a onclick="f_sort('tcrq');return false;"
           href="javascript:void(0);"> <span>停产日期</span><span class="arr"></span>
    </a>
    </th>

    <th><a onclick="f_sort('xsj');return false;"
           href="javascript:void(0);"> <span>销售价</span><span class="arr"></span>
    </a>
    </th>
    <th><a onclick="f_sort('dj');return false;"
           href="javascript:void(0);"> <span>单价</span><span class="arr"></span>
    </a>
    </th>
    <th><a onclick="f_sort('cbj');return false;"
           href="javascript:void(0);"> <span>成本价</span><span class="arr"></span>
    </a>
    </th>
    <th><a onclick="f_sort('wddbj');return false;"
           href="javascript:void(0);"> <span>网点调拨价</span><span
            class="arr"></span> </a>
    </th>
    <th><a onclick="f_sort('zdxsj');return false;"
           href="javascript:void(0);"> <span>最低销售限价</span><span
            class="arr"></span> </a>
    </th>
    <th><a onclick="f_sort('memo');return false;"
           href="javascript:void(0);"> <span>备&nbsp;注</span><span
            class="arr"></span> </a>
    </th>
    <th><a onclick="f_sort('czymc');return false;"
           href="javascript:void(0);"> <span>操作员名称</span><span
            class="arr"></span> </a>
    </th>
    <th><a onclick="f_sort('czrq');return false;" class=""
           href="javascript:void(0);"> <span>操作日期</span><span class="arr"></span>
    </a>
    </th>
</tr>
    ...
    <s:if
        ...
        <tr>
            <td align="center" nowrap><input type="checkbox"
                                             name="rowflag" value="<s:property value="#pzjg.vsn"/>"/></td>
            <!-- 物料编号 -->
            <td align="left"
                ondblclick="turn_modify_page('<s:property value="#pzjg.vsn"/>')"
                nowrap><s:property value="#pzjg.vsn" escape="false"/></td>
            <!-- 品牌 -->
            <td align="left"
                ondblclick="turn_modify_page('<s:property value="#pzjg.vsn"/>')"
                nowrap><s:property
                    value="@com.pub.util.tools@replaceNullStringWithNbsp(#pzjg.pp)"
                    escape="false"/></td>
            <!-- 车系 -->
            <td align="left"
                ondblclick="turn_modify_page('<s:property value="#pzjg.vsn"/>')"
                nowrap><s:property
                    value="@com.pub.util.tools@replaceNullStringWithNbsp(#pzjg.cx)"
                    escape="false"/></td>
            <!--  车系分类-->
            <td align="left"
                ondblclick="turn_modify_page('<s:property value="#pzjg.vsn"/>')"
                nowrap><s:property
                    value="@com.pub.util.tools@replaceNullStringWithNbsp(#pzjg.cxfl)"
                    escape="false"/></td>
            <!-- 车型描述 -->
            <td align="left"
                ondblclick="turn_modify_page('<s:property value="#pzjg.vsn"/>')"
                nowrap><s:property
                    value="@com.pub.util.tools@replaceNullStringWithNbsp(#pzjg.xhms)"
                    escape="false"/></td>
            <!-- 车辆颜色 -->
            <td align="left"
                ondblclick="turn_modify_page('<s:property value="#pzjg.vsn"/>')"
                nowrap><s:property
                    value="@com.pub.util.tools@replaceNullStringWithNbsp(#pzjg.clys)"
                    escape="false"/></td>
            <!-- 颜色未定 -->
            <td align="left"
                ondblclick="turn_modify_page('<s:property value="#pzjg.vsn"/>')"
                nowrap><s:property
                    value="@com.pub.util.tools@formatPzjgYswd(#pzjg.yswd)"
                    escape="false"/></td>
            <!-- 车型代码 -->
            <td align="left"
                ondblclick="turn_modify_page('<s:property value="#pzjg.vsn"/>')"
                nowrap><s:property
                    value="@com.pub.util.tools@replaceNullStringWithNbsp(#pzjg.xh)"
                    escape="false"/></td>
            <!-- 产品描述 -->
            <td align="left"
                ondblclick="turn_modify_page('<s:property value="#pzjg.vsn"/>')"
                nowrap><s:property
                    value="@com.pub.util.tools@replaceNullStringWithNbsp(#pzjg.cpms)"
                    escape="false"/></td>
            <!-- 状态 -->
            <td align="center"
                ondblclick="turn_modify_page('<s:property value="#pzjg.vsn"/>')"
                nowrap><s:property
                    value="@com.pub.util.tools@formatPzjgZt(#pzjg.zt)"
                    escape="false"/></td>
            <!--配置类型  -->
            <td align="left"
                ondblclick="turn_modify_page('<s:property value="#pzjg.vsn"/>')"
                nowrap><s:property
                    value="@com.pub.util.tools@replaceNullStringWithNbsp(#pzjg.pzlx)"
                    escape="false"/></td>
            <!-- 发动机型号 -->
            <td align="left"
                ondblclick="turn_modify_page('<s:property value="#pzjg.vsn"/>')"
                nowrap><s:property
                    value="@com.pub.util.tools@replaceNullStringWithNbsp(#pzjg.fdjxh)"
                    escape="false"/></td>
            <!-- ABS -->
            <td align="left"
                ondblclick="turn_modify_page('<s:property value="#pzjg.vsn"/>')"
                nowrap><s:property
                    value="@com.pub.util.tools@replaceNullStringWithNbsp(#pzjg.abs)"
                    escape="false"/></td>
            <!-- 内饰 -->
            <td align="left"
                ondblclick="turn_modify_page('<s:property value="#pzjg.vsn"/>')"
                nowrap><s:property
                    value="@com.pub.util.tools@replaceNullStringWithNbsp(#pzjg.ns)"
                    escape="false"/></td>
            <!--  选装件-->
            <td align="left"
                ondblclick="turn_modify_page('<s:property value="#pzjg.vsn"/>')"
                nowrap><s:property
                    value="@com.pub.util.tools@replaceNullStringWithNbsp(#pzjg.xzj)"
                    escape="false"/></td>
            <!-- 停产日期 -->
            <td align="center"
                ondblclick="turn_modify_page('<s:property value="#pzjg.vsn"/>')"
            ...
            <td align="left"
                ondblclick="turn_modify_page('<s:property value="#pzjg.vsn"/>' )"
                nowrap><s:property
                    value="@com.pub.util.tools@replaceNullStringWithNbsp(#pzjg.memo)"
                    escape="false"/>
            </td>
            <!-- 操作员名称 -->
            <td align="left"
                ondblclick="turn_modify_page('<s:property value="#pzjg.vsn"/>')"
                nowrap><s:property
                    value="@com.pub.util.tools@replaceNullStringWithNbsp(#pzjg.czymc)"
                    escape="false"/></td>
            <!-- 操作日期 -->
            <td align="center"
                ondblclick="turn_modify_page('<s:property value="#pzjg.vsn"/>')"
...
<div id="pagination_container" class="pagination">
    <table width="100%">
        <tr>
            <td align="right"><span class="page_skip">共<s:property
                    value="turnPage.totalLinesNum" default="0"/>条 第<s:property
                    value="turnPage.needDispPage" default="0"/>/ <s:property
                    value="turnPage.totalPages" default="0"/>页 </span> <s:if
                    test="turnPage.needDispPage == 1">
                <a id="gotoFirst" class="firstbtn">首页</a>
                <a id="gotoPrev" class="prebtn">上一页</a>
            </s:if> <s:elseif test="turnPage.needDispPage > 1">
                <a id="gotoFirst"
                   onclick="javascript:turnPage('<s:property
                           value="%{turnPage.needDispPage}"/>', 'toFirstPage');">首页</a>
                <a id="gotoPrev"
                   onclick="javascript:turnPage('<s:property value="%{turnPage.needDispPage}"/>', 'toPrePage');">上一页</a>
            </s:elseif> <s:else></s:else> <s:if
                    test="turnPage.needDispPage == turnPage.totalPages">
                <a id="gotoNext" class="nextbtn">下一页</a>
                <a id="gotoLast" class="lastbtn">尾页</a>
            </s:if> <s:elseif test="turnPage.needDispPage < turnPage.totalPages">
                <a id="gotoNext"
                   onclick="javascript:turnPage('<s:property
                           value="%{turnPage.needDispPage}"/>', 'toNextPage');">下一页</a>
                <a id="gotoLast"
                   onclick="javascript:turnPage('<s:property value="%{turnPage.needDispPage}"/>', 'toLastPage');">尾页</a>
            </s:elseif> <s:else></s:else> <input id="pageindex" type="text"
                                                 class="txt_pageindex"
                                                 value='<s:property value="%{turnPage.needDispPage}"/>'/> <a
                    id="gotoindex"
                    onclick="javascript:turnPage('<s:property
                            value="%{turnPage.needDispPage}"/>', 'choosePage');">Go</a>
            </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
...
<s:form name="form2" action=" " method="post">
    ...
    <s:hidden name="turnPage.needDispPage"
              value="%{turnPage.needDispPage}"/>
</s:form>
<!-- 删除功能调用 END -->
